...
export class M2pLoadbalancerStagingStack extends Construct {
    constructor(
        scope: Construct,
        id: string,
        ...
        // bookkeeper lb
        const bookkeeperLb = new Lb(scope, `elb-m2pslots-staging-bookkeeper`, {
            name: 'elb-m2pslots-staging-bookkeeper',
            internal: true,
        ...
        new LbListener(scope, `elb-m2pslosts-staging-bookkeeper-listener`, {
            ...
            defaultAction: [
                {
                    type: 'forward',
                    targetGroupArn: m2pBase.bookkeeperTargetStaging.arn,
                },
            ],
        });

        // slots lb
        const lb = new Lb(scope, `elb-m2pslots-staging`, {
            name: 'elb-m2pslots-staging',
            internal: false,
            loadBalancerType: 'application',
            securityGroups: [
        ...
        const listenerHttp = new LbListener(scope, `elb-m2pslots-staging-listener-http`, {
        ...
        const listenerHttps = new LbListener(scope, `elb-m2pslots-staging-listener-https`, {
            loadBalancerArn: lb.arn,
            port: 443,
            protocol: 'HTTPS',
            defaultAction: [
