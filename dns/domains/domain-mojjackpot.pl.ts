...
export class DnsDomainMojjackpotPl extends Construct {
    constructor(scope: Construct, id: string, _env: BaseEnvironment, loadbalancerSuite: DataAwsLb) {
        ...
        new Route53Record(this, `record-${domain}-txt`, {
            ...
            type: 'TXT',
            ttl: 300,
            records: ['google-site-verification=OKckHs6km85D1VYZO6kL2oQQAD3v9BjBMRAsb_lVXDc'],
        });
    }
}
