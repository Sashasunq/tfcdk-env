...
export class DnsDomainMaryvegasCom extends Construct {
    constructor(scope: Construct, id: string, env: BaseEnvironment, loadbalancerSuite: DataAwsLb) {
        ...
        new Route53Record(this, `record-${domain}-txt`, {
            ...
            type: 'TXT',
            ttl: 300,
            records: [env.defaultSpf, 'google-site-verification=9BvFSpmtSBEp7WTFEw1OuT3DxJxqb3LzFbFht1JipQE'],
        });
        ...
        new Route53Record(this, `record-${domain}-marketing-verification`, {
            zoneId: zone.id,
            name: 'scph0321._domainkey.marketing',
            type: 'TXT',
            ttl: 300,
            records: [
                // eslint-disable-next-line max-len
                'v=DKIM1; k=rsa; h=sha256; p=MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQChWDk1+oEnpYzgLCKBttF8k/o08ob+BtI2JkKmxQtvuaz404ITKmBsAyaa80D1fXCcYGfU16U3ShHVCWS2j9LTbBJYRky/8cNNDoEhC36MBbmlBXPiiI4kB7iPq8vMQ7bHuRvDajD4y3tSa5Tn6nUZLu+55WeE3BxJ9C7HS5NStQIDAQAB',
            ],
        });
        ...
        new Route53Record(this, `record-${domain}-service-verification`, {
            zoneId: zone.id,
            name: 'scph0321._domainkey.service',
            type: 'TXT',
            ttl: 300,
            records: [
                // eslint-disable-next-line max-len
                'v=DKIM1; k=rsa; h=sha256; p=MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC8u8LAE3dtPZeVqShngvXsxXcN2RvS3v3csN7ak9sK7SDFZrfxsugfiE9PVN7Z88KinZUSlIYPa2FEY51/Ly0N1IUb5CG2623a8CGiwKL4B/gY4WYeHIcprjTmZzR6dCwy0fTZ2nDIxtNd0Uj54oXxbpcHdkuQPbXJfOziZD1uDwIDAQAB',
            ],
        });
        ...
        new Route53Record(this, `record-${domain}-sendgrid-em506`, {
            zoneId: zone.id,
            name: 'em506',
            type: 'CNAME',
            ttl: 300,
