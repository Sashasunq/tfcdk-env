...
export class DnsDomainSpintalesSlotsCom extends Construct {
    constructor(scope: Construct, id: string, _env: BaseEnvironment, loadbalancerSuite: DataAwsLb) {
        super(scope, id);

        const domain = 'spintales-slots.com';
        ...
        new Route53Record(this, `record-${domain}-txt`, {
            ...
            type: 'TXT',
            ttl: 300,
            records: ['google-site-verification=F_pzZLilV_BahKdxrmdULdNSZ-726_u-5VD9YC4AW1U'],
        });
    }
}
