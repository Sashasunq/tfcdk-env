...
export class DnsDomainMojackpotPl extends Construct {
    constructor(scope: Construct, id: string, _env: BaseEnvironment, loadbalancerSuite: DataAwsLb) {
        ...
        new Route53Record(this, `record-${domain}-txt`, {
            ...
            type: 'TXT',
            ttl: 300,
            records: ['google-site-verification=PW4DXQxrAGKl5Zg5TAwt2j3R7rjdBT4ccqhNO59Tf9o'],
        });
    }
}
