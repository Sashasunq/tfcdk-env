...
export class DnsDomainVeraVegasCom extends Construct {
    constructor(scope: Construct, id: string, env: BaseEnvironment, loadbalancerSuite: DataAwsLb, dataElasticIpLegacySsl: DataAwsEip) {
        ...
        const cnameSubdomains = ['rtl', 'rtl2'];
        ...
        new Route53Record(this, `record-${domain}-txt`, {
            ...
            type: 'TXT',
            ttl: 300,
            records: [env.defaultSpf, 'google-site-verification=SdQ2Dt-jHiLUDkdErGcpFai2kai3lK7W6SbJo5BWRxE'],
        });
        ...
        new Route53Record(this, `record-${domain}-marketing-verification`, {
            ...
            records: [
                ...
                'v=DKIM1; k=rsa; h=sha256; p=MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDNLfVVQohMwvj7Sb597O5MZCoJrBaa+w4pdm6IFzUG29G0EDoYTirKh1F2WG2Q6fONUmTlvgnqVy4X6NePRuLbt97dr+VqavrpMYbUZdj7Bck0bjYUHniJXdYe/zGBVqFkHdyqnjd38EfKJfJg/+kmf+kkjYCx+8wKlj7qQYbu6QIDAQAB',
            ],
        });
        ...
        new Route53Record(this, `record-${domain}-service-verification`, {
            ...
            records: [
                // eslint-disable-next-line max-len
                'v=DKIM1; k=rsa; h=sha256; p=MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCzyeZPNVCVzh+r3pQ80Pw6CMhDyrggzivW7/7Lm3u8useLruNn1kyUooUVJhJynHMF1BP7Xa6mSYH0i70ebQmqwIQdEyyOrE+QkKpmRBeNxfh4nuDQ+mEFofZKkKzeOE2fNnnrkxGyIFKeuGwnFG8YqSyMUlCXFOrnxmRWsGlM6wIDAQAB',
            ],
        });
